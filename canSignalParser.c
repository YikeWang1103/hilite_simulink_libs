 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Thu Mar 05 15:14:27 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                canSignalParser
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 startBit
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 isSigned
...
/* Input Port  6 */
#define IN_PORT_6_NAME                 isBigEndian
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port data of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port startBit of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port length of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port isSigned of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port factor of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port offset of S-Function canSignalParser");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port isBigEndian of S-Function canSignalParser");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function canSignalParser");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const int8_T *startBit = (int8_T *) ssGetInputPortRealSignal(S, 1);
  const int8_T *length = (int8_T *) ssGetInputPortRealSignal(S, 2);
  const boolean_T *isSigned = (boolean_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *factor = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *offset = (real_T *) ssGetInputPortRealSignal(S, 5);
  const boolean_T *isBigEndian = (boolean_T *) ssGetInputPortRealSignal(S, 6);
  real_T *y0 = (real_T *) ssGetOutputPortRealSignal(S, 0);
  canSignalParser_Outputs_wrapper(data, startBit, length, isSigned, factor,
    offset, isBigEndian, y0);
}
